...
| AC-2 | VERIFIED | Fixture evidence for AC-2. |
| AC-3 | VERIFIED | Fixture evidence for AC-3. |

Fresh-context agent, no memory of the build, per DESIGN.md phase 9. Audited against the fixture
spec's §10 AC-1…AC-3, branch `fixture-branch`. Misplaced: this paragraph belongs before the table.
